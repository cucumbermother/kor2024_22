...
public class BoardController {
    ...
    public ArrayList<BoardDto> boardPrint( ){
        ...
        // void 대신 여러개 게시물 반환 받고 싶어 => void -> ArrayList
        // BoardDao에게 게시물 전체출력 함수를 호출해서 결과를 받는다
        // 1. Boarddao 에게 게시물 전체출력 함수를 호출한다.
        // BoardDao의 메소드를 호출하기 위해 객체 생성
        // 2. BoardDao에게 메소드를 호출하고 응답(모든게시물) 받기
        ArrayList<BoardDto> result = BoardDao.getInstance().boardPrint();
        // BoardDao 에게 응답받은 결과를 view 응답하기
        return result; // return 현재 메소드가 종료되면서 반환 되는 값
    }
